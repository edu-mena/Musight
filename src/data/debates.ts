...
export const debates: Debate[] = [
  {
    ...
    summary: "O processo de reforma dos preços dos combustíveis visa corrigir distorções macroeconómicas graves. Especialistas explicam o modelo de transição.",
    participants: 892,
    experts: 8,
    date: "Hoje",
    hot: true,
  ...
  },
  {
    ...
    summary: "O debate sobre as eleições autárquicas foca na prontidão das infraestruturas e na sustentabilidade financeira dos novos municípios.",
    participants: 567,
    experts: 5,
    date: "Ontem",
    hot: true,
  ...
  },
  {
    ...
    summary: "O Plano de Acção para a Promoção da Empregabilidade já beneficiou milhares de jovens. Analisamos a eficácia desta estratégia de fomento.",
    participants: 1200,
    experts: 12,
    date: "2 dias",
    hot: true,
  ...
  },
  {
    ...
    summary: "Angola está a liderar a transição energética na África Subsariana com investimentos massivos em energia limpa.",
    participants: 432,
    experts: 4,
    date: "3 dias",
    hot: false,
  ...
  },
  {
    ...
    summary: "O combate à corrupção permitiu a recuperação de biliões de dólares em bens e dinheiro. Como estão a ser usados estes fundos?",
    participants: 750,
    experts: 6,
    date: "4 dias",
    hot: true,
  ...
  },
  {
    ...
    summary: "A produção nacional está a crescer. Angola caminha para a auto-suficiência em cereais essenciais.",
    participants: 310,
    experts: 3,
    date: "5 dias",
    hot: false,
