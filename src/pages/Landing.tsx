...
const FEATURES = [
  {
    ...
    desc: "Participa em debates sobre as notícias do dia. Especialistas e cidadãos, lado a lado.",
  },
  {
    icon: BookOpen,
    title: "Níveis de Explicação",
    desc: "A mesma notícia em 3 profundidades — do resumo simples à análise técnica.",
  },
  {
    icon: Zap,
    title: "Termos-Chave",
    desc: "Palavras difíceis ficam sublinhadas. Clica para ver a definição sem sair do texto.",
  },
  {
    icon: Bot,
    title: "Weza",
    desc: "Faz perguntas sobre qualquer artigo. A Weza responde com contexto e fontes verificadas.",
  },
  {
    icon: Headphones,
    title: "Girassol Lê",
    desc: "Artigos narrados em áudio. Ouve enquanto vives o teu dia — 3 episódios por semana.",
  },
  {
    icon: Users,
    title: "Especialistas Comentam",
    desc: "Economistas, juristas e médicos explicam o contexto das notícias em primeira mão.",
  },
];
  ...
  <div className="bg-background">
      ...
      <div className="relative max-w-6xl mx-auto px-5 py-20 grid lg:grid-cols-2 gap-14 items-center w-full">
        <div className="animate-fade-up text-white">
          ...
          <p className="mt-6 text-lg text-white/75 max-w-lg">
            ...
            com termos-chave interactivos e a Weza para as tuas perguntas.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              to="/login"
              className="btn-ghost border-white/30 !text-white hover:!bg-white hover:!text-foreground"
            >
              Já tenho conta
            </Link>
          </div>
          <div className="mt-10 flex gap-8">
            {STATS.map((s) => (
              <div key={s.label}>
                ...
                <div className="text-xs text-white/50 font-mono-accent uppercase tracking-wider mt-0.5">
                  {s.label}
                </div>
              </div>
            ))}
          ...
          <div className="w-64 h-[500px] rounded-[2.5rem] border-4 border-white/20 bg-white/5 backdrop-blur-sm relative overflow-hidden shadow-2xl">
            ...
            <div className="p-4 pt-8 space-y-3">
              ...
              <div className="rounded-xl bg-white/10 border border-white/15 p-3">
                <div className="text-[9px] font-mono-accent uppercase text-orange-300 mb-1">
                  Debate · Economia
                </div>
                <div className="text-white text-xs font-semibold leading-snug">
                  A subida dos combustíveis é inevitável?
                </div>
                <div className="mt-2 flex gap-2 text-[9px] text-white/50">
                  <span>312 participantes</span>
                  <span>·</span>
              ...
              <div className="rounded-xl bg-white/10 border border-white/15 p-3">
                ...
                <div className="text-white text-xs font-semibold leading-snug">
                  BNA sobe taxa para 19,5%
                </div>
                <div className="mt-2 flex items-center gap-1 text-[9px]">
                  <span className="px-1.5 py-0.5 rounded-full bg-orange-500/30 text-orange-200">
                    Básico
                  </span>
                  <span className="px-1.5 py-0.5 rounded-full bg-white/10 text-white/50">
                    Intermédio
                  </span>
                  <span className="px-1.5 py-0.5 rounded-full bg-white/10 text-white/50">
                    Avançado
    ...
    <section className="py-20 px-5 max-w-6xl mx-auto">
      <div className="text-center mb-12">
        <span className="font-mono-accent text-xs uppercase tracking-wider text-primary">
          Funcionalidades
        </span>
        <h2 className="font-display font-bold text-3xl md:text-4xl mt-2">
          Mais do que notícias.
          <br />
          <span className="text-gradient">Compreensão.</span>
        </h2>
      </div>
      ...
      <div className="flex items-end justify-between mb-8">
        <div>
          ...
          <h2 className="font-display font-bold text-3xl mt-1">
            Em destaque <span className="text-gradient">agora</span>
          </h2>
        </div>
        <Link
          to="/register"
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1.5 leading-relaxed">
                Com os subsídios a serem progressivamente retirados, até onde podem ir os preços dos
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  A retirada dos subsídios é necessária para a sustentabilidade fiscal, mas o ritmo
            ...
            {[
              {
                id: 1,
                category: "Política",
                title: "As autarquias vão mudar Angola?",
                participants: 198,
                experts: 3,
              },
              {
                id: 2,
                category: "Saúde",
                title: "Sistema de saúde público: reforma urgente?",
                participants: 145,
                experts: 2,
              },
            ].map((d) => (
              <div key={d.id} className="card-app p-5">
                <span className="pill bg-primary/10 text-primary mb-2 inline-flex">
                  {d.category}
                </span>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-t from-background via-background/80 to-transparent rounded-2xl">
            <div className="text-center p-6">
              ...
              <p className="text-sm text-muted-foreground mb-5">
                Acesso gratuito a todos os debates, artigos e à Weza.
              </p>
      ...
      <div className="max-w-2xl mx-auto text-center bg-surface-darker rounded-3xl p-12 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="mt-3 text-white/70 text-lg">
            Registo gratuito. Sem publicidade. Feito para Angola.
          </p>
