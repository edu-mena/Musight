...
export const ManageArticles = () => {
  ...
  useEffect(() => {
    api.get<ApiArticle[]>("/admin/articles")
      .then(setItems)
      .catch(() => {})
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-4">
      ...
      {loading ? (
        ...
        <div className="card-app p-10 text-center text-sm text-muted-foreground">Sem artigos nesta categoria.</div>
      ) : (
              ...
              <article key={a.id} className="card-app p-4 space-y-2">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className={`pill ${statusPill[a.status] ?? "bg-muted text-muted-foreground"}`}>
                  ...
                  isRejecting ? (
                    <div className="p-3 rounded-xl border border-red-200 bg-red-50 space-y-2">
                      ...
                      <div className="flex gap-2 justify-end">
                        ...
                        <button onClick={() => reject(a.id)} disabled={!rejectReason.trim()}
                    ...
                    <div className="flex gap-2 pt-2 border-t border-border mt-1">
                      ...
                      <button onClick={() => { setActiveReject(a.id); setRejectReason(""); }}
                ...
                {a.status === "recusado" && a.rejection_reason && (
                  <div className="p-2 rounded-lg bg-red-50 border border-red-100">
                    <p className="text-[11px] text-red-700"><span className="font-semibold">Motivo: </span>{a.rejection_reason}</p>
                  </div>
                )}
              </article>
            );
